        ...
        <div class="glass-card p-8 rounded-2xl">
            <form action="{{ route('devices.update', $device) }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <input type="text" value="{{ $device->device_id }}" readonly disabled
                           class="w-full px-4 py-3 bg-gray-100 dark:bg-white/5 border border-white/20 rounded-lg text-gray-500 dark:text-gray-400 cursor-not-allowed">
                </div>
                ...
                <div class="mb-6">
                    ...
                    <textarea name="description" id="description" rows="3"
                              class="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 text-gray-900 dark:text-white placeholder-gray-500">{{ old('description', $device->description) }}</textarea>
                    @error('description')
                        <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mb-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="latitude" id="latitude" value="{{ old('latitude', $device->latitude) }}"
                               class="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 text-gray-900 dark:text-white placeholder-gray-500"
                               placeholder="-6.2088">
                        @error('latitude')
                        <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                    ...
                    <div>
                        ...
                        <input type="text" name="longitude" id="longitude" value="{{ old('longitude', $device->longitude) }}"
                               class="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 text-gray-900 dark:text-white placeholder-gray-500"
                ...
                @push('scripts')
                    ...
                    <script>
                        document.addEventListener('DOMContentLoaded', function() {
                            // Default: Jakarta or Device Location
                            var defaultLat = {{ $device->latitude ?? -6.9744 }};
                            var defaultLng = {{ $device->longitude ?? 107.6303 }};
                            ...
                            } else if ({{ $device->latitude ? 'true' : 'false' }}) {
                ...
                <div class="mb-6">
                    <label for="mqtt_topic" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                        MQTT Topic
                    </label>
                    <input type="text" value="{{ $device->mqtt_topic }}" readonly disabled
                           class="w-full px-4 py-3 bg-gray-100 dark:bg-white/5 border border-white/20 rounded-lg text-gray-500 dark:text-gray-400 cursor-not-allowed font-mono text-sm">
                </div>
